...
public class UtilPropSwapp {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "D:\\SwEngrProject\\workspace4830\\workspace4830-ex-0915-swapp\\webproject\\WebContent\\config.properties";
